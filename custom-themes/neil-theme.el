...
(custom-theme-set-faces
 'neil
 '(default ((t (:family "Cascadia Code" :foundry "outline" :width normal :height 110 :weight regular :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "#bbc2cf" :background "#282c34" :stipple nil :inherit nil))))
 '(cursor ((t (:background "#8888cc"))))
 ...
 '(next-error ((t (:inherit (region)))))
   ;;;; Centaur-tabs
 '(centaur-tabs-selected ((t (:background "#404080" :foreground "#ffffff"))))
