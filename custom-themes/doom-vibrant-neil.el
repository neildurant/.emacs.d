;;; doom-vibrant-theme-neil.el --- a more vibrant variant of doom-one -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-vibrant-theme-neil nil
  "Options for the `doom-vibrant-neil' theme."
  :group 'doom-themes)

(defcustom doom-vibrant-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-vibrant-theme-neil
  :type 'boolean)
...
(def-doom-theme doom-vibrant-neil
...
;;; doom-vibrant-theme-neil.el ends here
